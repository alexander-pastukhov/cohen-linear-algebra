...
### Exercise 2 {-}
Note that figure 11.5 in the book (at least in my electronic edition) has only _negative_ values for log determinant, meaning that all average determinants were less than  1. Neither code below, not the original solution code replicates that. I have a feeling that figure 11.5 plots $log(mean(dets)) - 40$ but I have no idea why.
```{r}
library(ggplot2)
