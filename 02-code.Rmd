...
### Code block 2.9/2.10 {-}
For this example, you can also use atomic vectors directly without turning them into a single column matrix.
```{r}
...
R implementation of [LU matrix decomposition](https://stat.ethz.ch/R-manual/R-patched/library/Matrix/html/LU-class.html) works only on _square_, positive definite matrices.
```{r}
